...
// Inicia la sesión
session_start(); 
$nombre_usuario = $_SESSION['nombre_usuario']; // Recupera el nombre de usuario de la sesión
if (!isset($_SESSION['nombre_usuario'])) {
  // Si no hay una sesión activa, redirige al usuario a 'login.php'
...
<html lang="es">
          ...
          <div class="heroContainer home-hero1">
            <div class="home-container02">
              ...
              <div class="home-btn-group">
                <button class="buttonFlat"></button>
                <button class="buttonFlat scroll-to-top-button" id="buttonhidd"></button>
              </div>
            </div>
          </div>          
        </div>
          ...
          <div class="home-features1" >                    
              <div class="home-container03"  >
                ...
                <h2 class="home-features-heading heading2" >
                   Descubre lugares turísticos de Ambato
                </h2 >
                <span class="home-features-sub-heading bodyLarge" >
                  <span>
                    <span>
                      <span>
                       Elige una de las categorías que se presenta a continuación.
                      </span>
                      <span></span>
                    </span>
                    <span>
              ...
              <div class="home-container04">
                ...
                <img src="components/icons/park.png" class="featuresIcon" alt="Icono de parque">
                  <div class="feature-card-container" id="features">
                    ...
                    <span class="bodySmall">
                      <span>
                      Descubra los impresionantes parques de Ambato, 
                      desde el exuberante Parque Cevallos hasta el asombroso Parque 
                      de los enamorados.
                      </span>
                    </span>
                  </div>
                ...
                <img src="components/icons/fast-food.png" class="featuresIcon" alt="Icono de restaurante">
                  <div class="feature-card-container">
                    ...
                    <span class="bodySmall">
                      <span>
                      Descubra la exquisita gastronomía de Ambato, 
                      en sus diversos restaurantes. Desde Marisquerías 
                      donde se presenta las delicias del mar, hasta bufets  
                      donde puede disfrutar de una experiencia culinaria  variada.
                      </span>
                    </span>
                  </div>
                </div>
                <div class="featuresCard feature-card-feature-card">
                <img src="components/icons/colonial.png" class="featuresIcon" alt="Icono de Museo">
                  <div class="feature-card-container">
                    <h3 class="feature-card-text heading3">
                      <span>Museos</span>
                    </h3>
                    <span class="bodySmall">
                      <span>
                      Descubra los fascinantes museos de Ambato, 
                      que albergan una rica colección de arte, historia y cultura, 
                      desde el Museo Casa del Portal con su impresionante colección 
                      de arte religioso, hasta el fascinante mundo que alberga el 
                ...
                <div class="featuresCard feature-card-feature-card">
                <img src="components/icons/church.png" class="featuresIcon" alt="Icono de Iglesia">
                  <div class="feature-card-container">
                    <h3 class="feature-card-text heading3">
                      <span>Iglesias</span>
                    </h3>
                    <span class="bodySmall">
                      <span>
                      Descubra las impresionantes iglesias de Ambato, 
                      desde la majestuosa Catedral de Ambato, 
                      que se levanta con una belleza inigualable, 
                      hasta la Iglesia Barrio Solis, un lugar de paz y tranquilidad.
                      </span>
                    </span>
                  </div>
                </div>
  ...
  <label>
    ...
    <div class="alert success">
      ...
      <span class="alertText">¡Bienvenido, <?php echo $nombre_usuario; ?>!
      <br class="clear"/></span>
    </div>
  </label>
</div>
